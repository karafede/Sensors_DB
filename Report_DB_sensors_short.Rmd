...
rownames(df_metrics) <- c("", "$R^{2}$ from calibrations", "$R^{2}$ from comparisons", "slope of reg. line", 
                          "RMSE", "Uncertainity (U)")
